package com.credibanco.bankinc.dfsv.component.persistence.CE;

import com.credibanco.bankinc.dfsv.application.BankIncRestServiceApplication;
import com.credibanco.bankinc.dfsv.component.persistence.dao.tables.CardsDAO;
import com.credibanco.bankinc.dfsv.component.persistence.dao.tables.TransactionsDAO;
...
import com.credibanco.bankinc.dfsv.model.persistence.jdbc.RowMapper.TransactionsRowMapper;
import com.credibanco.bankinc.dfsv.utilitary.BankIncACGRConstants;
import com.credibanco.bankinc.dfsv.utilitary.Utilitario;
...
public class BankIncACGRCE {
    ...
    private static final Logger log = LoggerFactory.getLogger(BankIncRestServiceApplication.class);
    @Autowired
